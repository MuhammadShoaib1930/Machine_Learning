...
score = 0
for i in range(0,1):
    x_train , x_test,y_tran, y_test = train_test_split(x,y,test_size=0.25,random_state=452)
...
tt_score = model.score(x_test,y_test)*100
tn_score = model.score(x_train,y_tran)*100
